package net.javawind.t_api.beans;
...
public class OAuth {
	...
	private String oauth_callback = "";// 认证成功后浏览器会被重定向到这个url中
	...
	public List<QParameter> getParams() {
		...
		parameters
				.add(new QParameter("oauth_consumer_key", oauth_consumer_key));
		parameters.add(new QParameter("oauth_signature_method",
